...
CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount &genesisReward) {
    const char *pszTimestamp = "The Unode Play2018 is right here";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1517052119, 119039, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock ==
               uint256S("0x00000acefa18a4f06dd3cf401df33488253351b18433fdb20dc192a0361e18d4"));
        assert(genesis.hashMerkleRoot ==
               uint256S("0x49571207a3169bf5bec5324dcb02648b1e2dc5f6dcc0db192f20e5c33ad39c37"));
